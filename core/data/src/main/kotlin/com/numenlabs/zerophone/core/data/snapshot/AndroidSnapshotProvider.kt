...
/**
 * Android [SnapshotProvider]: local time-of-day / day-of-week (device
 * timezone) and calendar-busy state from [CalendarSource]. java.util.Calendar
 * (not java.time) keeps it usable on minSdk 24 without desugaring.
 */
